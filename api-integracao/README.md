...
Esta é a API de Integração do e-Agendas, destinada aos órgãos e sistemas autorizados.
...
Para emitir o token de integração, será desenvolvido um processo de autorização, validando o IP dos servidores que utilização o serviço de integração.
Os formulários de solicitação ainda estão em desenvolvimento, contudo, caso queira testar essa integração, favor abrir um _issue_ nesse repositório 
para entrarmos em contato e validar sua requisição.
...
- [Rotas da API](./postman/e-Agendas%20-%20v2%20-%20INTEGRAÇÃO.postman_collection.json)
